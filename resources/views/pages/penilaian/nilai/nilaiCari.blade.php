      ...
      <div class="block block-rounded">
        <div class="block-header block-header-default">
          <h3 class="block-title">
            Detail Nilai Guru {{$gurus->nama}}
          </h3>
          <a href="{{route('nilai')}}" class="btn btn-secondary mx-2">Kembali</a>
          @if (auth()->user()->role == 'ADMIN')
            <a href="{{route('nilaiGrEdit', $gurus->id)}}" class="btn btn-warning">Edit Nilai</a>
          @endif
        </div>
